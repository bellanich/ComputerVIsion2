...
# print('E_shape_sigma:', np.shape(E_shape_sigma))
...
pointCloud2 = mean_shape + E_shape_sigma
pointCloud3 = mean_shape + E_shape_sigma + mean_exp + E_exp_sigma
